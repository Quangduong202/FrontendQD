        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner" style={{backgroundImage:"url('/images/banner/banner-1-bg.jpg')"}} >
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="single-banner custom-responsive-margin"
                       style={{backgroundImage:"url('/images/banner/banner-2-bg.jpg')"}} >
            ...
            <div class="row">
                <div class="col-lg-8 col-md-12 col-12">
                    ...
                    <div class="single-banner right"
                      style={{backgroundImage:"url('/images/banner/banner-3-bg.jpg')",marginTop: "30px"}}>
        ...
        <div class="container">
            ...
            <div class="brands-logo-wrapper">
                <div class="brands-logo-carousel d-flex align-items-center justify-content-between">
                    ...
                    <div class="brand-logo">
                        <img src="/images/brands/04.png" alt="#"/>
                    </div>
                    <div class="brand-logo">
                        <img src="/images/brands/05.png" alt="#"/>
                    </div>
                    <div class="brand-logo">
                        <img src="/images/brands/06.png" alt="#"/>
                    </div>
                    <div class="brand-logo">
                        <img src="/images/brands/03.png" alt="#"/>
                    </div>
